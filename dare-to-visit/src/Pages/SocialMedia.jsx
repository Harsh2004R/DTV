            ...
            >
                ...
                >
                    ...
                    <Box position="fixed"
                        ...
                        bottom="50%"
                        zIndex="1"
                        w={{ base: "25px", md: "28px", lg: "25px" }}
                        h={{ base: "25px", md: "28px", lg: "25px" }}
                    ...
                    >
                        {showHiddenBox ? (
                            <FaAnglesLeft size={{ base: "20px", md: "28px", lg: "30px" }} color='#fff' />
                        ) : (
                            <FaAnglesRight size={{ base: "20px", md: "28px", lg: "30px" }} color='#fff' />
                        )}
                    </Box>
